      ...
      <div className="resources-container">
        ...
        <div className="resource-card">
          <Link to="/athletics-articles">
            <img src="article.jpg" alt="Articles" className="resource-image" />
            <h3>Articles</h3>
        ...
        <div className="resource-card">
          <Link to="/athletics-audio">
            <img src="audio.png" alt="Audio" className="resource-image" />
            <h3>Audio</h3>
        ...
        <div className="resource-card">
          <Link to="/athletics-videos">
            <img src="video.png" alt="Videos" className="resource-image" />
            <h3>Videos</h3>
        ...
        <div className="resource-card">
          <Link to="/athletics-stories">
            <img src="story.jpg" alt="Stories" className="resource-image" />
            <h3>Stories</h3>
        ...
        <div className="resource-card">
          <Link to="/athletics-dosdonts">
            <img src="do.png" alt="Do's and Don'ts" className="resource-image" />
