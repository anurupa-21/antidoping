  ...
  return (
    <div className="athletics-audio-page">
      <div className="athletics-header">
        <h1>Cricket Anti-Doping Audio Resources</h1>
        <p>Your guide to understanding anti-doping practices in cricket through audio resources</p>
      </div>

      <div className="audio-container">
        {/* Audio 1 */}
        <div className="audio-card">
          <h3>Anti-Doping Awareness in cricket - Podcast</h3>
          <iframe 
