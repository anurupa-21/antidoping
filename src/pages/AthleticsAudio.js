...
import './AthleticsAudio.css';

const AthleticsAudio = () => {
    useEffect(() => {
  ...
  return (
    <div className="athletics-audio-page">
      <div className="athletics-header">
        <h1>Athletics Anti-Doping Audio Resources</h1>
        <p>Your guide to understanding anti-doping practices in athletics through audio resources</p>
      </div>

      <div className="audio-container">
        {/* Audio 1 */}
        <div className="audio-card">
          <h3>Anti-Doping Awareness in Athletics - Podcast</h3>
          <iframe 
