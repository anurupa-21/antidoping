...
import './WrestlingAudio.css';
import React, { useEffect } from 'react';
const WrestlingAudio = () => {
  useEffect(() => {
  ...
  return (
    <div className="athletics-audio-page">
      <div className="athletics-header">
        <h1>Wrestling Anti-Doping Audio Resources</h1>
        <p>Your guide to understanding anti-doping practices in Wrestling through audio resources</p>
      </div>

      <div className="audio-container">
        {/* Audio 1 */}
        <div className="audio-card">
          <h3>Anti-Doping Awareness in Wrestling - Podcast</h3>
          <iframe 
